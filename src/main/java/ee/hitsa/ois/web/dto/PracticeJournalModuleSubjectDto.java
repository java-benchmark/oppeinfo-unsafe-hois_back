...
public class PracticeJournalModuleSubjectDto {
    ...
    public static PracticeJournalModuleSubjectDto of(PracticeJournalModuleSubject moduleSubject) {
        if (moduleSubject == null) {
            return null;
        }
        return EntityUtil.bindToDto(moduleSubject, new PracticeJournalModuleSubjectDto());
    }
